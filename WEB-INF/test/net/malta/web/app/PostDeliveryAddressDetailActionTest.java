...
public class PostDeliveryAddressDetailActionTest {
    ...
    public void setUp() {
        ...
        deliveryAddress.setId(new Integer(1));
        ...
        deliveryAddressForm.setId(new Integer(1));
    }
    ...
    public void testExecute1() {
    	...
    	new NonStrictExpectations() {{
    		...
    		httpServeltRequest.getParameter("deliverymethod"); result= "1"; result= "1";
    		criteria.uniqueResult(); result= deliveryAddress;
    	}};
    ...
    public void testExecute2() {
    	...
    	new NonStrictExpectations() {{
    		httpServeltRequest.getAttribute("form"); result= deliveryAddressForm; result= deliveryAddressForm; result= deliveryAddressForm;
    		httpServeltRequest.getParameter("id"); result= "1"; result= "1";
    		httpServeltRequest.getParameter("deliverymethod"); result= "1"; result= "1";
    		criteria.uniqueResult(); result= deliveryAddress;
    	}};
