...
public class GiftCardsActionTest {
    ...
    public void testExecute1() {
    	...
    	new NonStrictExpectations() {{
    		...
    		httpServeltRequest.getParameter("id"); result= "3"; result= "3";
    	}};
    ...
    public void testExecute2() {
    	...
    	new NonStrictExpectations() {{
    		criteria.uniqueResult(); result= giftCard;
    		httpServeltRequest.getAttribute("form"); result= giftCardForm; result= giftCardForm; result= giftCardForm;
    		httpServeltRequest.getParameter("id"); result= "3";
    	}};
