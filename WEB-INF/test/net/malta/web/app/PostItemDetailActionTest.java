...
public class PostItemDetailActionTest {
    ...
    public void testExecute1() {
    	...
    	new NonStrictExpectations() {{
    		httpServeltRequest.getAttribute("form"); result= null;
    		httpServeltRequest.getParameter("id"); result= "1"; result= "1";
    		httpServeltRequest.getParameter("product"); result= "1"; result= "1";
    ...
    public void testExecute2() {
    	...
    	new NonStrictExpectations() {{
    		httpServeltRequest.getAttribute("form"); result= itemForm; result= itemForm;
    		httpServeltRequest.getParameter("id"); result= "1"; result= "1";
    		httpServeltRequest.getParameter("product"); result= "1"; result= "1";
    		criteria.uniqueResult(); result= item; result= product;
    	}};
