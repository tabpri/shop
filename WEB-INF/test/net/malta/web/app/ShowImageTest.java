...
public class ShowImageTest {
    ...
    public void testExecute1() {
    	...
    	new NonStrictExpectations() {{
    		...
    		criteria.uniqueResult(); result= attachment; result= staticData;
    	}};
		...
		try {
			image.execute(actionMapping, actionForm, httpServeltRequest, httpServletResponse);
		} catch (Exception e) {
			fail(e.getMessage());
		}
    ...
    public void testExecute2() {
    	...
    	new NonStrictExpectations() {{
    		httpServeltRequest.getParameter("id"); result= "1"; result= "1";
    		criteria.uniqueResult(); result= null; result= staticData;
    	}};
